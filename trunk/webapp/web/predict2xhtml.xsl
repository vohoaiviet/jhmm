...
<head><title>JHMM Demonstration - Sequence State Prediction</title>
<xsl:call-template name="style"/>
</head>
<body>
<xsl:call-template name="navigation"/>
<p class="title">Predict a States for a Sequence</p>
<form method="POST" action="predict-decision.jsp">
...
<p class="error">You must specify a sequence to get a prediction upon.</p>
</xsl:if>
</li>
<li>
<p>Make it go!
